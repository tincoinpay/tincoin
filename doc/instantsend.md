...
This mechanism has been integrated into Bitcore-Node-Tincoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tincoinpay/insight-api-tincoin#web-socket-api](https://github.com/tincoinpay/insight-api-tincoin#web-socket-api)
* API: [https://github.com/tincoinpay/insight-api-tincoin#instantsend-transactions](https://github.com/tincoinpay/insight-api-tincoin#instantsend-transactions)
...
By default, the Tincoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tincoin Core daemon:
