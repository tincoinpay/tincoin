    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tincoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Tincoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tincoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Tincoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TINCOIN, 0.1 TINCOIN, 1 TINCOIN and 10 TINCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tincoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://tincoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tincoin Core is shutting down...") + "<br /><br />" +
