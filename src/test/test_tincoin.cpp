...
#define BOOST_TEST_MODULE Tincoin Test Suite

#include "test_tincoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_tincoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
