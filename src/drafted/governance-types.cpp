...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TincoinNetwork") type = TincoinNetwork;
    if(strType == "TincoinNetworkVariable") type = TincoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TincoinNetwork) s = "TincoinNetwork";
    if(type == TincoinNetworkVariable) s = "TincoinNetworkVariable";
